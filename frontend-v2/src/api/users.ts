...
export const usersApi = {
  ...
  getUser: (id: string) => client.get<ItemResponse<User>>(`/api/users/${id}`),
  ...
  anonymize: (id: string) => client.post(`/api/users/${id}/anonymize`),
  ...
  gdprAnonymize: (id: string) =>
    client.delete(`/api/users/${id}/gdpr-anonymize`),
};
