...
export function useUsersPage() {
  ...
  function setSearchInput(v: string) { setSearchInputRaw(v); setPage(1) }
  function setRoleFilter(v: string) { setRoleFilterRaw(v); setPage(1) }
  function setDeptFilter(v: string) { setDeptFilterRaw(v); setPage(1) }
  function setStatusFilter(v: string) { setStatusFilterRaw(v); setPage(1) }
  ...
  return {
    ...
    anonymizeTarget, setAnonymizeTarget,
