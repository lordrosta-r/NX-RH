...
const PHOTOS = [
  ...
  { src: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDVFnNsEdKs7Qrn-6bKFZqSO3QZmo0wJW9_QZSddmXpnLzsY8hv_aXWMQXeuSeUNB8rReC-aNJcL5reeVaiRahcmcSkJ4XkN0X7eFxp1odqjrbq2nXkW4RPE6f-JtFoNSuccHklrEo84Av1dm8rOhBDj17PjCiLoyulDybPejFpunJ8lGJGwRAZO8v0nJHIqgj2vUM_lI-ZlZ-PRJLKZMqDU_dudHlmg8Lc7tq770U-jaUwunOxSqauwTgjBCjbr0vh_-uGkfvGsyUx', alt: '' },
      ...
      <div className="mosaic" aria-hidden="true">
        {PHOTOS.map((photo, i) => (
          <div key={i} className="mosaic__cell">
            <img src={photo.src} alt="" className="mosaic__img" loading="eager" decoding="async" />
          </div>
        ))}
      </div>
