    ...
    >
      ...
      >
        <div className="px-6 py-4 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between flex-shrink-0">
          ...
          <button
            onClick={onClose}
            className="text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-colors rounded-lg p-1 focus-visible:ring-2 focus-visible:ring-primary-300"
            aria-label="Fermer"
          >
            <X className="w-5 h-5" />
          </button>
