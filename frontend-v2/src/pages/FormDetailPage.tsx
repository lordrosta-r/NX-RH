        ...
        <div className="flex items-center gap-2 flex-wrap justify-end">
          {isAdminOrHr && (
            <button
              ...
              className="inline-flex items-center gap-2 border border-slate-200 hover:bg-slate-50 px-4 py-2 rounded-md text-sm font-medium text-slate-700 transition-colors"
            >
          ...
          {isAdmin && !isFrozen && (
            <button
              ...
              className="inline-flex items-center gap-2 bg-error-500 hover:bg-error-600 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors"
            >
          ...
          {isAdmin && isFrozen && (
            <button
              ...
              className="inline-flex items-center gap-2 bg-warning-500 hover:bg-warning-600 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors"
            >
        ...
        <div className="col-span-12 lg:col-span-4 space-y-4">
          <div className="bg-white rounded-xl border border-slate-200 p-5">
            ...
            <div className="mb-4">
              ...
              <div
                className={`inline-flex px-3 py-1.5 rounded-lg text-sm font-medium ${FORM_TYPE_CONFIG[form.formType]?.color ?? "bg-slate-100 text-slate-700"}`}
              >
                {FORM_TYPE_CONFIG[form.formType]?.label ?? form.formType}
              </div>
            </div>
                ...
                isFrozen ? (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2 flex-wrap">
                      <span className="w-6 h-6 rounded-full bg-slate-200 text-slate-600 text-xs font-medium flex items-center justify-center flex-shrink-0">
                        {idx + 1}
                      </span>
                    ...
                    <p className="text-sm text-slate-700">
                      {q.text || <em className="text-slate-500">Sans texte</em>}
                    </p>
          ...
          <div className="bg-white rounded-xl p-6 w-full max-w-md shadow-xl">
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-medium bg-error-500 text-white rounded-md hover:bg-error-600 disabled:opacity-50"
              >
          ...
          <div className="bg-white rounded-xl p-6 w-full max-w-md shadow-xl">
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-medium bg-warning-500 text-white rounded-md hover:bg-warning-600 disabled:opacity-50"
              >
